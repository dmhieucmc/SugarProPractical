...
{{#notEq this.length 0}}
    {{#each this.models}}
        <li><a href="javascript:void(0);" data-id="{{getFieldValue this "id"}}" data-type="{{getFieldValue this "dashboard_type"}}">{{getFieldValue this "name"}}</a></li>
    {{/each}}
{{/notEq}}
',
    ),
...
<div class="btn-group" data-toggle="buttons-radio">
    <button class="btn layout{{#eq value 1}} active{{/eq}}" rel="tooltip" title="{{str "LBL_DASHBOARD_1_COLUMN_LAYOUT" module}}" data-placement="bottom" data-value="1" track="click:1columnlayout"><i class="icon-list-alt"></i></button>
    <button class="btn layout{{#eq value 2}} active{{/eq}}" rel="tooltip" title="{{str "LBL_DASHBOARD_2_COLUMN_LAYOUT" module}}" data-placement="bottom" data-value="2" track="click:2columnlayout"><i class="icon-columns"></i></button>
    <button class="btn layout{{#eq value 3}} active{{/eq}}" rel="tooltip" title="{{str "LBL_DASHBOARD_3_COLUMN_LAYOUT" module}}" data-placement="bottom" data-value="3" track="click:3columnlayout"><i class="icon-table"></i></button>
</div>
',
    ),
    'controller' => 
...
divider+=component.width;}},this);this.setSliderPosition(metadata);this.model.set("metadata",metadata,{silent:true});this.model.trigger("change:layout");},bindDataChange:function(){if(this.model){this.model.on("change:metadata",this.render,this);}},bindDomChange:function(){}})',
  ...
  '_hash' => '4577813e5dae937ed84307b174c0d753',
);
