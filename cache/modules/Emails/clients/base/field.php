...
--}}
<label class="btn" for="{{fileInputId}}">{{#if def.icon}}<i class="{{def.icon}}"></i>{{/if}}{{str label}}</label>
',
    ),
  ),
  'compose-actionbar' => 
...
',
  ...
  array (
    ...
    array (
      'quickcreate' => '
<a data-action="email" href="javascript:void(0);" track="click:quickCreate-Emails" tabindex="-1">{{#if def.icon}}<i class="{{def.icon}}"></i>{{/if}}{{label}}</a>
',
    ),
    'controller' => 
    array (
...
',
  ...
  '_hash' => '11a80f933cae1264ebc059a7a4318100',
);
