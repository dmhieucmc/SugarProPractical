...
return emails;}},focus:function(){if(this.action!=='disabled'){this._getNewEmailField().focus();}},_retrieveEmailOptionsFromLink:function($link){return{to_addresses:[{email:$link.data('email-to'),bean:this.emailOptions.related}]};}}) },
...
this.unbindDom();},_dispose:function(){app.routing.offBefore('route',this.beforeRoute,this);if(this.bwcModel){this.bwcModel.off();this.bwcModel=null;}
